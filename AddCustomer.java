...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer() {
        ...
        lblid.setBounds(100,80,300,30); 
        lblid.setFont(new Font("Railway", Font.PLAIN,20));
        add(lblid);
        
        String options[] = {"Aadhar Card", "Passport", "Driving License", "Voter-id Card", "PAN CARD "};
        ...
        lblnumber.setBounds(30,120,300,30); 
        ...
        lblname.setBounds(30,160,300,30); 
        ...
        lblgender.setBounds(30,200,300,30); 
        ...
        lblcountry.setBounds(30,240,300,30); 
        ...
        add(checkintime);
          ...
          lbldeposit = new JLabel ("Deposite");
